...
EnsembleMCMC moves: linear: DE; logistic: DE; poisson: DE; robust: DE; eight_schools: DE; signal-background: Stretch.
...
Offline configuration search: `ensemble-screen-2026-09-17.toml`, SHA-256 `828a5577a1def503cd0f3fc81aebb20dd3e28c5a254427630e6672f07f452b64`. Screening seeds: 8301, 8302, 8303. Selection: minimum mean(seconds * standardized mean squared error), subject to moment checks.
...
| linear | EnsembleMCMC DE / CPU | 21.7 | 5e+02–5.7e+02 | 1.043 | 0.00914 | 0.0229 |
| linear | EnsembleMCMC Stretch / CPU | 22.1 | 30–1.1e+02 | 1.160 | 0.017 | 0.0433 |
| linear | EnsembleMCMC snooker / CPU | 22.5 | 25–49 | 1.184 | 0.0173 | 0.0485 |
...
| logistic | EnsembleMCMC DE / CPU | 10.7 | 1.1e+03–1.6e+03 | 1.008 | 0.00721 | 0.0134 |
| logistic | EnsembleMCMC Stretch / CPU | 10.6 | 86–3.4e+02 | 1.070 | 0.0207 | 0.0233 |
| logistic | EnsembleMCMC snooker / CPU | 11.6 | 1.8e+02–3.1e+02 | 1.079 | 0.021 | 0.0365 |
...
| poisson | EnsembleMCMC DE / CPU | 4.44 | 3.5e+03–3.7e+03 | 1.025 | 0.00555 | 0.0197 |
| poisson | EnsembleMCMC Stretch / CPU | 4.44 | 2e+02–9.4e+02 | 1.067 | 0.0113 | 0.0347 |
| poisson | EnsembleMCMC snooker / CPU | 12.7 | 62–5.2e+02 | 1.073 | 0.0138 | 0.0323 |
...
| robust | EnsembleMCMC DE / CPU | 4.32 | 2.6e+03–4.1e+03 | 1.019 | 0.00912 | 0.0207 |
| robust | EnsembleMCMC Stretch / CPU | 4.89 | 4.9e+02–9.2e+02 | 1.043 | 0.0128 | 0.0341 |
| robust | EnsembleMCMC snooker / CPU | 8.42 | 2.5e+02–3.5e+02 | 1.044 | 0.00683 | 0.0329 |
...
| eight_schools | EnsembleMCMC DE / CPU | 0.974 | 7e+03–1.1e+04 | 1.012 | 0.00781 | 0.0179 |
| eight_schools | EnsembleMCMC Stretch / CPU | 0.977 | 1.9e+03–3.4e+03 | 1.038 | 0.0255 | 0.0938 |
| eight_schools | EnsembleMCMC snooker / CPU | 0.997 | 2.2e+03–3e+03 | 1.063 | 0.0179 | 0.0587 |
...
| signal-background | EnsembleMCMC DE / CPU | 2.57 | 8.6e+02–1.8e+03 | 1.018 | 0.0134 | 0.162 |
| signal-background | EnsembleMCMC Stretch / CPU | 2.56 | 5e+02–9e+02 | 1.046 | 0.0211 | 0.298 |
| signal-background | EnsembleMCMC snooker / CPU | 2.58 | 4e+02–8.7e+02 | 1.063 | 0.0369 | 0.459 |
...
| linear | EnsembleMCMC DE / CPU | 3 | 21.1–22.2 |
| linear | EnsembleMCMC Stretch / CPU | 3 | 22.1–22.2 |
| linear | EnsembleMCMC snooker / CPU | 3 | 22.2–22.7 |
...
| logistic | EnsembleMCMC DE / CPU | 3 | 10.6–11 |
| logistic | EnsembleMCMC Stretch / CPU | 3 | 10.5–10.7 |
| logistic | EnsembleMCMC snooker / CPU | 3 | 11.5–11.6 |
...
| poisson | EnsembleMCMC DE / CPU | 6 | 4.28–4.61 |
| poisson | EnsembleMCMC Stretch / CPU | 6 | 4.18–4.71 |
| poisson | EnsembleMCMC snooker / CPU | 3 | 7.49–23.1 |
...
| robust | EnsembleMCMC DE / CPU | 6 | 4–4.97 |
| robust | EnsembleMCMC Stretch / CPU | 5 | 4.57–5.36 |
| robust | EnsembleMCMC snooker / CPU | 3 | 8.34–8.53 |
...
| eight_schools | EnsembleMCMC DE / CPU | 9 | 0.875–1.1 |
| eight_schools | EnsembleMCMC Stretch / CPU | 9 | 0.934–1.06 |
| eight_schools | EnsembleMCMC snooker / CPU | 9 | 0.949–1.07 |
...
| signal-background | EnsembleMCMC DE / CPU | 6 | 2.47–2.68 |
| signal-background | EnsembleMCMC Stretch / CPU | 6 | 2.41–2.63 |
| signal-background | EnsembleMCMC snooker / CPU | 6 | 2.43–2.89 |
...
| linear | EnsembleMCMC DE / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
| linear | EnsembleMCMC Stretch / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
| linear | EnsembleMCMC snooker / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
...
| logistic | EnsembleMCMC DE / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
| logistic | EnsembleMCMC Stretch / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
| logistic | EnsembleMCMC snooker / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
...
| poisson | EnsembleMCMC DE / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
| poisson | EnsembleMCMC Stretch / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
| poisson | EnsembleMCMC snooker / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
...
| robust | EnsembleMCMC DE / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
| robust | EnsembleMCMC Stretch / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
| robust | EnsembleMCMC snooker / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
...
| eight_schools | EnsembleMCMC DE / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
| eight_schools | EnsembleMCMC Stretch / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
| eight_schools | EnsembleMCMC snooker / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
...
| signal-background | EnsembleMCMC DE / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
| signal-background | EnsembleMCMC Stretch / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
| signal-background | EnsembleMCMC snooker / CPU | [ensemble-results-2026-09-17.toml](ensemble-results-2026-09-17.toml) |
